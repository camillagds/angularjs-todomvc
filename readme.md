# AngularJS & RequireJS TodoMVC Example [![Build Status](https://travis-ci.org/camillagds/angularjs-todomvc.svg?branch=master)](https://travis-ci.org/camillagds/angularjs-todomvc)
